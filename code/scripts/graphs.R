#part 2
#setwd("C:/Users/Lydia/Documents/project3")
...
jpeg("./images/total_completion.png")
...
#plot of black population vs threshold earnings
jpeg("./images/black_threshold_all.png")
p2 <- ggplot(clean_2012, aes(x = clean_2012$Black, y = clean_2012$ThresholdEarnings))
p2 + geom_point(aes(color=factor(clean_2012$SchoolType))) +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        ...
        axis.text.x = element_blank()) +
  labs(x = "% black pop.",
       y = "threshold earnings",
       title = "Black Population of School vs Threshold Earnings",
       color = "School Type\n")
dev.off()

#same plot, only for public school though
jpeg("./images/black_threshold_public.png")
p3 <- ggplot(clean_2012_public, aes(x = clean_2012_public$Black, y = clean_2012_public$ThresholdEarnings))
p3 + geom_point() +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        axis.title.y = element_text(face="bold", color="black", size=12),
        plot.title=element_text(size=15, face="bold"),
  ...
  labs(x = "% black pop.",
       y = "threshold earnings",
       title = "Public Schools Black Pop. vs Threshold Earnings")
dev.off()

jpeg("./images/black_completion_all.png")
p4 <- ggplot(clean_2012, aes(x = clean_2012$Black, y = clean_2012$Completion4yr))
p4 + geom_point() +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        axis.title.y = element_text(face="bold", color="black", size=12),
        plot.title=element_text(size=15, face="bold"),
...
p5 <- ggplot(clean_2012_public, aes(x = clean_2012_public$Black, y = clean_2012_public$Completion4yr))
p5 + geom_point() +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        axis.title.y = element_text(face="bold", color="black", size=12),
        plot.title=element_text(size=15, face="bold"),
  ...
  labs(x = "% black pop.",
       y = "Completion Rates",
       title = "Public School %Black Population vs 4yr Completion Rates")
dev.off()
...
p7 <- ggplot(clean_2012, aes(x = clean_2012$Avg_SAT, y = clean_2012$Completion4yr))
p7 + geom_point(aes(color = clean_2012$ThresholdEarnings)) +
  labs(x = "Avg SAT Score",
       y = "4 yr Completion Rates",
       title = "Avg SAT Scores vs 4yr Completion Rates",
       color = "Threshold Earnings\n")+
...
jpeg("./images/avgSAT_threshold.png")
p8 <- ggplot(clean_2012, aes(x = clean_2012$Avg_SAT, y = clean_2012$ThresholdEarnings))
p8 + geom_point() +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        axis.title.y = element_text(face="bold", color="black", size=12),
        plot.title=element_text(size=15, face="bold"),
  ...
  labs(x = "Avg SAT Score",
       y = "Threshold Earnings",
       title = "Avg SAT Scores vs Threshold Earnings")
dev.off()

jpeg("./images/costattend_threshold.png")
p9 <- ggplot(clean_2012, aes(x = clean_2012$CostAttendance, y = clean_2012$ThresholdEarnings))
p9 + geom_point() +
  theme(axis.title.x = element_text(face="bold", color="black", size=12),
        axis.title.y = element_text(face="bold", color="black", size=12),
        plot.title=element_text(size=15, face="bold"),
  ...
  labs(x = "Cost of Attendance",
       y = "Threshold Earnings",
       title = "Cost of Attendance vs Threshold Earnings")
dev.off()
...
correlation_matrix = cor(clean_2012[, c(which(colnames(clean_2012)== "Total"),
                      ...
                      which(colnames(clean_2012)== "Completion4yr"))]) 
